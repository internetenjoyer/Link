...
32. [ ] Projeye, link listesinde tamamen dinamik olarak çalışacak bir arama kutucuğu ekleyelim. Konumu link listesinin üstünde yer alan "tümünü seç" işleminin bulunduğu "select-all-header" olabilir, burada sağa yaslı durabilir. Bu ve benzeri tüm güncellemeleri yaparken, projedeki mevcut değişkenler ve yapıyı koruyalım ki kritik hatalar yol açmayalım.
33. [ ] Linklerin sürüklenerek yer değiştirebilmesini tamamen projeden kaldıralım.
34. [ ] Filtre alanında ve dışa aktarma ekranındaki: marka, kategori ve gönderi tiplerinin tamamında bulunan dropdownları, çoklu seçim yapılabilir bir hale getirmeliyiz. Seçilen öğeler dropdownın hemen üst kısmına belirtilmeli. bu özel dropdown widgetleri içerisinde tümünü seç ve tümünü kaldır işlevleri olmalı.
35. [ ] Projenin tasarımını ve şeklini olduğu gibi koruyarak, yalnızca yapı elementlerini tamamen semantic olacak şekilde bir düzenleme yapar mısın?
